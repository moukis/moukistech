  ...
  return (
    <div className="bg-[#050507] text-white min-h-screen overflow-x-hidden">
      ...
      <main className="mx-auto max-w-3xl px-5 sm:px-8 pt-36 pb-28">
        ...
        {notFound ? (
          <p className="font-mono-tech text-white/40">Article introuvable.</p>
        ) : !post ? (
          <p className="font-mono-tech text-white/40">Chargement...</p>
        ) : (
          <article data-testid="blog-article">
            ...
            <p className="mt-4 font-mono-tech text-xs text-white/40">{format(new Date(post.created_at), "PPP", { locale: fr })}</p>
            {post.cover_image && (
        ...
        <div className="mt-16 rounded-2xl border border-white/10 bg-white/[0.03] p-8 text-center">
          <p className="font-display font-700 text-xl">Un problème avec votre appareil ?</p>
